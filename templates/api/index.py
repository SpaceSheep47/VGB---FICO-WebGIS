...
from flask import Flask, render_template, jsonify, Response, abort, send_file, request
...
def list_panoramas():
    """
    Retorna as fotos 360° georreferenciadas encontradas no diretório
    configurado. O conteúdo da fotografia não é carregado nesta etapa.
    """
...
def panorama_file(panorama_id):
    """Entrega uma fotografia 360° já indexada, sem expor caminhos do servidor."""
